...
-Output:
- Print out a comfirmation that the broker has been connected successfully: "Connected to MQTT Broker!"
- Print out the number of total recieved data points
- Print out the recieved JSON data
- Print out the topic that the data has been recieved from
